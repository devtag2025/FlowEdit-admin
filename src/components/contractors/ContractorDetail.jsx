...
import { Clock, Edit, Mail, Trash2, Upload, Send, CheckCircle2 } from "lucide-react";
      ...
      <div className="bg-tertiary rounded-t-3xl p-4 pb-6 space-y-3">
        ...
        <div className="bg-tertiary rounded-xl p-3">
          ...
          <div className="flex gap-2">
            ...
            <Button
              className="flex-1 bg-primary hover:bg-primary/90 text-tertiary h-9 text-xs font-semibold rounded-lg"
            >
