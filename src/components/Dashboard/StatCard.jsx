...
const StatCard = ({ icon: Icon, title, value, subtitle, progress, trend, type }) => {
        ...
        return (
          <div className="space-y-2">
            <div className="flex items-center justify-between text-xs">
              <span className="text-accent/60">{progress.current}/{progress.total} Capacity</span>
            </div>
  ...
  return (
    <div className="bg-tertiary rounded-2xl p-3 space-y-4 hover:shadow-lg transition-shadow">
      ...
      <div>
        ...
        <h3 className="text-3xl font-bold text-accent">{value}</h3>
