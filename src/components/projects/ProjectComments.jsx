...
const initialMessages = [
  ...
  },
  {
    ...
    time: "23 hours ago",
    message:
      "Note: Client mentioned preferring warmer tones in previous project. Keep that in mind for color grading final pass.",
    avatar: null,
    isEditor: true,
  },
  {
    ...
    time: "Yesterday",
    message:
      "This is looking fantastic! Ready to move forward with the final review. Great work team! 🎉🔥",
    avatar: null,
  },
];
